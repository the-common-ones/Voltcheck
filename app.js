...
function getSourceNote(r,syB20,syT20,rMin,rMax,pMin,pMax){
  ...
  if(r==='carib') return'Benchmarks: SIE Dominican Republic, Global Solar Atlas Caribbean, Climatescope 2025. Rate range: 
...
+rMax+'/kWh. '+base;
  if(r==='sam-n') return'Benchmarks: UPME Colombia, Global Solar Atlas Andean region, Intratec 2025. Rate range: 
...
+rMax+'/kWh. '+base;
  if(r==='sam-s') return'Benchmarks: ANEEL Brazil, Global Solar Atlas Southern Cone, Intratec 2025. Rate range: 
...
+rMax+'/kWh. '+base;
  if(r==='europe-s') return'Benchmarks: ENTSO-E, Global Solar Atlas Southern Europe, Eurostat 2025. Rate range: 
...
+rMax+'/kWh. '+base;
  return'Benchmarks: Philippine DOE, Meralco rates, Global Solar Atlas Southeast Asia. Rate range: 
